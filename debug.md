...
| Compliance export downloads broken / serves HTML | `sw.js` `API_RE` must include `/export` (fixed since `camp-v4`; current cache is **`camp-v15`**). If the workbook itself 500s, see the audit-workbook row below (illegal sheet name). |
